  ...
  class Renderer
    ...
    def balance_report
      ...
      lines = [
        ...
        "",
        "Generated artifacts currently provide runtime skill metadata C++, monster topology metadata C++, monster registration glue, and review reports.",
        "",
        "## Summary",
        "",
    ...
    def manifest
      {
        ...
        "runtime_authority" => "Ruby DSL generated C++ skill metadata, monster known-skill metadata, encounter pool tables, and monster registration glue; handwritten C++ skill behavior and monster construction primitives",
